...
#'
#' Clinically plausible upper and lower limits for biomarker values, in standard UK units (ACR: mg/mmol / g/mol, ALT: U/L, blood albumin: g/L, AST: U/L, total bilirubin: umol/L, BMI: kg/m2, blood creatinine: umol/L, DBP: mmHg, fasting glucose: mmol/L, haematocrit: %, haemoglobin: g/L, HbA1c: mmol/mol, HDL: mmol/L, height: m, LDL: mmol/L, PCR: mg/mmol / g/mol, SBP: mmHg, total cholesterol: mmol/L, triglycerides: mmol/L, weight: kg). These limits were decided after consultation with clinicians. Entries outside these limits are considered data entry errors and should be excluded. Biomarkers with more than one-commonly used unit must be converted to standard units (haematocrit: proportion between 0 and 1, haemoglobin: g/L, HbA1c: mmol/mol). Biomarkers included: ACR, ALT, blood albumin, AST, bilirubin, BMI, blood creatinine, DBP, fasting glucose, haematocrit, haemoglobin, HbA1c (mmol/mol), HDL, height, LDL, PCR, SBP, total cholesterol, triglycerides, and weight. BMI, height, and weight limits are for adult measurements only.
#'
#' @docType data
